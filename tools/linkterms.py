...
TERMS = [
    ...
    ("四弘誓願","g-shigu",None),("廻向","g-eko",None),("三乗","g-sanjo",None),
    ("方便","g-houben",None),("中観","g-chugan",None),("大乗非仏説","g-hibussetsu",None),
    ("如来","g-nyorai",r"(?<![陀迦師日])如来(?![蔵寿])"),("三身","g-sanjin",r"(?<!十)三身"),
    ("観音菩薩","g-kanjizai",None),("観音経","g-kanjizai",None),("観音","g-kanjizai",None),
    ("地蔵菩薩","g-jizo",None),("地蔵","g-jizo",None),
    ("弥勒菩薩","g-miroku",None),("弥勒","g-miroku",None),
    ("明王","g-myoo",r"(?<![動染頭])明王"),("天部","g-tenbu",None),
    ("久遠実成","g-kuon",None),("華厳経","g-kegon",None),("維摩経","g-yuima",None),
    ...
    ("鎮護国家","g-chingo",None),("僧兵","g-souhei",None),("檀家制度","g-danka",None),
    ("一念三千","g-ichinen",None),("平生業成","g-heizei",None),("四箇格言","g-shika",None),
    ("曼荼羅本尊","g-mandarahonzon",None),("賦算","g-fusan",None),
